...
int randx = 1;
int r7rand() { return (((randx = randx * 1103515245 + 12345) >> 16) & 077777); }
...
int rnum(int n) { return (int)(((float)r7rand() / 32768.0) * (float)n); }
...
int near(struct roomst* ap, int ahaz) {
    struct roomst* p;
    int haz, i;
